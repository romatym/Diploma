...
class BaseController extends \App\Controller {
    ...
    function loginAsAdmin(&$errors, $login, $password) {
        $adminManager = new \Models\AdminsModel();
     ...
     */
    function checklogin() {
        if (!empty($_POST['login']) && !empty($_POST['password']) && !empty($_POST['signIn'])) {
            return TRUE;
        } else {
            return FALSE;
        }
    ...
    public function accounts() {
        ...
        $categoriesManager = new \Models\CategoriesModel();
    ...
    public function answer() {
        ...
        $questionsManager = new \Models\QuestionsModel();
    ...
    public function sendAnswer() {
        ...
        $answersManager = new \Models\AnswersModel();
    ...
    public function hideQuestion() {
        ...
        if (!empty($id)) {
            $questionManager = new \Models\QuestionsModel();
